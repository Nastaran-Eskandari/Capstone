...
export default class Comment extends Component {
  ...
  render() {
              ...
              <div className="container"   key={i}>
                <blockquote className="quote-box">
                  ...
                  <div className="blog-post-actions">
                    <p className="blog-post-bottom pull-left"> #{item.Tag.name} </p>
                    <p className="blog-post-bottom pull-right">
                      <span className="badge quote-badge"> {item.emoji} </span>
                    </p>
                  </div>
                </blockquote>
              </div>
    ...
    return (
      ...
      <ScrollableAnchor id={'comments-section'} scrollDuration={2} keepLastAnchorHash={false}>
         <ScrollAnimation animateIn="fadeIn" duration={.5} animateOnce= {true}>
