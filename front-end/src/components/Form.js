...
export default class Form extends Component {
    ...
    constructor(){
        ...
        this.emojiTypeInput = React.createRef();
      ...
      commentSubmit = (e) => {
        ...
        const body = {
          ...
          emoji : this.emojiTypeInput.current.value,
          tag : this.tagInput.current.value,
        }
  ...
  render() {
    return (
      ...
      <ScrollableAnchor id={'form-section'} scrollDuration={2} keepLastAnchorHash={false}>
        ...
        <h2 className="">FORM</h2>
          ...
          <ScrollAnimation animateIn="fadeInUp" duration={1} animateOnce= {true}>
            <form className="form__wrapper--form" onSubmit={this.commentSubmit}  ref={this.myForm} >
              <label>COMMENT </label>
              <textarea className="comment-input " row="6"
                type="text" name="comment-Input" ref={this.commentInput} required />
              <label > EMOJI  </label>
              <select  className="comment-input" ref={this.emojiTypeInput}>
                <option value=" 💜">💜</option>
                <option value=" 💔"> 💔</option>
                <option value="😡">😡</option>
                <option value="😢">😢</option>
              ...
              <label   type="text" name="tag-Input">TAG </label>
              <input  type="text" name="tag-Input" ref={this.tagInput} required pattern="[^#]+" title="Do not put #"/>
             {/* <a className="submit-btn" type="submit" href="#comments-section" ><p>SEND</p></a> */}
