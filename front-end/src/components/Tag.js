    ...
    render() {
        ...
        const TagData = () =>{
            return tags.map((item,i) => {
                return (
                    <div className="tag-style"  key={i}>
                    <Link  to={"/comments/"+ item.name} className="tag-link"> <span>#{item.name}</span> </Link>
                    </div>
                    )
                  })
                }
        ...
        return (
          ...
          <ScrollableAnchor id={'tag-section'} scrollDuration={2} keepLastAnchorHash={false}>
            <div className="tag" >
              ...
              <div className="tags-section">
                <Link  to={"/"} className="tag-link all-comments"> <span>All comments</span> </Link>
                {TagData()}
              </div>
            </div>
          </ScrollableAnchor>
